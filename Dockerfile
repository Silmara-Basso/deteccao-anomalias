...
RUN curl https://archive.apache.org/dist/spark/spark-3.5.2/spark-3.5.2-bin-hadoop3.tgz -o spark-3.5.2-bin-hadoop3.tgz \
...
ENV SPARK_MASTER="spark://spark-master-sil:7077"
ENV SPARK_MASTER_HOST spark-master-sil
